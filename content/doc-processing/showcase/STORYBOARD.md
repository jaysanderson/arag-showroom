...
| 5 | 14 s | Document detail, Record tab: the trust strip ("12 of 12 fields carry a verified quote", exact/near/none breakdown) and the reconciliation warning | `.dip-grounding` + the issue `.arag-alert.warn` | Full page — strip is the first element, issue directly beneath it | `05-record.png` | 00:42 "Every record opens with this strip…" |
