...
| 2:30–2:37 | Send it. 200, the timing, the headers, the body. | "And it is a real request against this deployment. That search you saw earlier was this call." | `GET /api/v1/calls?q=double+charged` |
